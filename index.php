...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <h1 class="h1">
                    My Form&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<a href="display.php" class='mylink'>View Info</a></h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="number" name="phone" id="phone" size="10" class="form-control" placeholder="Enter Phone" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Address</label>
  ...
  <option value="zimbabwean">Zimbabwean</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="edu" id="edu" class="form-control" rows="5" cols="35" required="required"
